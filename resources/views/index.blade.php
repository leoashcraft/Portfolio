                ...
                <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                    ...
                    <div class="xl:hidden mt-7 pt-6 border-t border-platinum dark:border-greyBlack">
                        ...
                        <a href="{{ config('app.static_url') }}/Ashcraft-Leo-Resume.pdf" download target="_blank"
                            class="inline-flex items-center gap-2 text-sm border border-theme bg-theme text-white py-3 px-6 rounded-4xl transition duration-300 hover:bg-themeHover hover:border-themeHover font-semibold">
                            DOWNLOAD RESUME
