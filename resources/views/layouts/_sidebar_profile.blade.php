...
<div class="hidden xl:block w-full mx-auto minfo__sidebar__wrapper xl:fixed xl:top-1/2 xl:left-4 2xl:left-14 xl:-translate-y-1/2 md:max-w-sidebar xl:max-2xl:max-w-xs z-999">
    <div class="p-3 max-xl:mb-3 overflow-hidden minfo__sidebar bg-white dark:bg-nightBlack rounded-2xl">
        ...
        <div class="pt-6 mx-4 border-t lg:mx-6 user-meta-info md:mx-7 my-7 border-platinum dark:border-metalBlack">
            <ul class="space-y-3 *:flex *:text-sm">
                <li>
                    <span class="flex-1 font-medium text-black dark:text-white">Location:</span>
                    <span>Dallas-Fort Worth</span>
                </li>
                <li>
                    <span class="flex-1 font-medium text-black dark:text-white">Phone:</span>
                    <span class="scramble-phone" data-user="(309)" data-website="2874-836"></span>
                </li>
                <li>
                    <span class="flex-1 font-medium text-black dark:text-white">Email:</span>
                    <span class="scramble-email" data-user="oel" data-website="hcet.tfarchsa"></span>
                </li>
            </ul>
        </div>
        <div class="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
            <div class="text-sm font-medium text-black dark:text-white">Primary Stack</div>
            <div class="flex items-center justify-between my-4 space-x-4 skills_circle *:space-y-2 *:text-center">
                <div class="progressCircle">
                    <div class="relative w-12 h-12 circle" data-percent="90" data-circlefill="#71b7d5" data-circleempty="#777777">
                        <div class="absolute inset-0 text-[13px] font-medium label flex-center">90%</div>
                    </div>
                    <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/90">HTML/CSS</p>
                </div>
                <div class="progressCircle">
                    <div class="relative w-12 h-12 circle" data-percent="85" data-circlefill="#71b7d5" data-circleempty="#777777">
                        <div class="absolute inset-0 text-[13px] font-medium label flex-center">85%</div>
                    </div>
                    <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/85">PHP</p>
                </div>
                <div class="progressCircle">
                    <div class="relative w-12 h-12 circle" data-percent="80" data-circlefill="#71b7d5" data-circleempty="#777777">
                        <div class="absolute inset-0 text-[13px] font-medium label flex-center">80%</div>
                    </div>
                    <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/80">JS</p>
                </div>
                <div class="progressCircle">
                    <div class="relative w-12 h-12 circle" data-percent="75" data-circlefill="#71b7d5" data-circleempty="#777777">
                        <div class="absolute inset-0 text-[13px] font-medium label flex-center">75%</div>
                    </div>
                    <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/75">SQL</p>
                </div>
            </div>
            <div class="mt-6">
